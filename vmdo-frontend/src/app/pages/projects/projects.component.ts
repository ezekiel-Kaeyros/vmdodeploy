  ...
  ngOnInit(): void {
    ...
    this.projectSubscription$ = this.projectService.projectSubject$.subscribe((response: Project[]) => {
        ...
        this.projects = this.projects.map(project => {
          let subDes = project.description.substring(0, 130);
          subDes = subDes.substring(0, subDes.lastIndexOf(' '));
          subDes += '...';
          project.description = subDes;
          project.photoUrl = `${this.apiUrl}/media/${project.photoUrl}`;
          project.logoUrl = `${this.apiUrl}/media/${project.logoUrl}`;
          project.sponsorLogoUrl = `${this.apiUrl}/media/${project.sponsorLogoUrl}`;
          return project;
        });
