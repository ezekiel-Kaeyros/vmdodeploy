...
import 'whatwg-fetch';
import { DocumentListItem } from './Models/ViewerTypes';
type ReportInfo = {
    name: string;
    path: string;
    title: string;
...
export declare function fetchDocumentList(pdfViewer: GcPdfViewer, documentListUrl?: string | DocumentListItem[]): void;
