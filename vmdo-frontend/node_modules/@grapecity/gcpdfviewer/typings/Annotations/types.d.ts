...
export declare type SetMultiplePropertiesFn<Val = any> = (pageIndex: number, originalNode: AnnotationBase, descriptors: PropertyDescriptor[], values: Val[]) => Promise<any>;
export type AnnotationsMsg = {
    type: 'reset';
};
