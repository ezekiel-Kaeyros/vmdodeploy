...
export declare function findDestinationPageNumber(linkAnnotation: {
    dest: (object | number | null)[];
    destPageNumber?: number;
} | {
    gen: number;
    num: number;
}, viewer: any): Promise<number | null>;
export declare function findLinkPageNumber(linkAnnotation: {
    dest: (object | number | null)[];
    destPageNumber?: number;
}, viewer: any): number;
