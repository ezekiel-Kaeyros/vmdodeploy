...
import { OpenParameters, OptionalContentConfig, PageViewport, SaveSettings, StructTreeNode, ViewerFeatureName, ViewerPreferences, IGCEventBus, DocumentListItem, SubmitFormOptions } from './Models/ViewerTypes';
...
export declare class GcPdfViewer extends ReportViewer {
    ...
    getType(typeName: string): typeof React | typeof AnnotationBase | typeof ReactDOM | typeof GcPdfViewer | typeof PdfReportPlugin | typeof AnnotationTypeCode | typeof utf8ToBase64 | typeof EditMode | typeof GenericButton | typeof ViewerStatus | typeof ViewerOptions | typeof LayoutMode | typeof Toolbar | typeof ViewMode | typeof ZoomMode | typeof GcMeasurement | typeof GcPdfSearcher | typeof GcRightSidebar | null;
    ...
    collectQuadPoints(paintedBoxes: {
        pageIndex: number;
        x: number;
        y: number;
        w: number;
