...
//@ts-ignore
import { NotificationManagerProps, ToolbarStatus } from '@grapecity/core-ui';
...
export declare type ReportViewerOptions = {
    ...
    /** Defines the position of notification appearance and rounding. */
...
export declare class ReportViewer implements PluginModel.IViewerHost {
    ...
    /**
        Gets/sets target element for zoom transformation.
    ...
    get enableSidebarInFullscreen(): boolean;
    set enableSidebarInFullscreen(enableSidebarInFullscreen: boolean);
