...
//@ts-ignore
import { Icon, Size, ToolbarStatus } from '@grapecity/core-ui';
import { ChangedEventArgs, ReportViewer } from '../../control';
import { MouseMode, ViewerStatus, ZoomSettings } from '../DocumentViewer';
import { ZoomControlProps } from './controls/Zoom';
...
export interface ToolbarViewProps {
    ...
    i18n: i18nInstance;
    size: Size;
    zoomOptions: ZoomControlProps['options'];
