...
<div class="tsd-signature">Page<wbr/>Structure<wbr/>Change<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>add<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>checkNumPages<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>modOnly<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>mod<span class="tsd-signature-symbol">?: </span><a href="PageModification.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageModification</a><span class="tsd-signature-symbol"> }</span></div>
...
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> mod<span class="tsd-signature-symbol">?: </span><a href="PageModification.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageModification</a></h5></li></ul></div></div>
