<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>UserAccess | GcDocs PDF Viewer - v4.2.3</title><meta name="description" content="Documentation for GcDocs PDF Viewer - v4.2.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-signature">User<wbr/>Access<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>userName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>accessMode<span class="tsd-signature-symbol">: </span><a href="../enums/SharedAccessMode.html" class="tsd-signature-type" data-tsd-kind="Enumeration">SharedAccessMode</a><span class="tsd-signature-symbol"> }</span></div>
...
<h5>user<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5></li>
<li class="tsd-parameter">
<h5>access<wbr/>Mode<span class="tsd-signature-symbol">: </span><a href="../enums/SharedAccessMode.html" class="tsd-signature-type" data-tsd-kind="Enumeration">SharedAccessMode</a></h5></li></ul></div></div>
