<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>SignatureInfo | GcDocs PDF Viewer - v4.2.3</title><meta name="description" content="Documentation for GcDocs PDF Viewer - v4.2.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-signature">Signature<wbr/>Info<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>contactInfo<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>location<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>signerName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>reason<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>signatureField<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
...
<pre><code class="language-javascript"><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;test.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">sign:</span><span class="hl-1"> { </span><span class="hl-0">signatureField:</span><span class="hl-1"> </span><span class="hl-3">&quot;field1&quot;</span><span class="hl-1">, </span><span class="hl-0">signerName:</span><span class="hl-1"> </span><span class="hl-3">&quot;John Doe&quot;</span><span class="hl-1"> } } );</span>
</code></pre>

<h3>Example</h3><p>Example of server side signing implementation</p>
<pre><code class="language-csharp"><span class="hl-7">// Example: electronically sign PDFs with a .PFX certificate:</span><br/><br/><span class="hl-5">public</span><span class="hl-1"> </span><span class="hl-5">void</span><span class="hl-1"> </span><span class="hl-6">Configuration</span><span class="hl-1">(</span><span class="hl-11">IAppBuilder</span><span class="hl-1"> </span><span class="hl-0">app</span><span class="hl-1">) {</span><br/><span class="hl-1">    </span><span class="hl-0">GcPdfViewerController</span><span class="hl-1">.</span><span class="hl-0">Settings</span><span class="hl-1">.</span><span class="hl-0">Sign</span><span class="hl-1"> += </span><span class="hl-0">_OnSign</span><span class="hl-1">;</span><br/><span class="hl-1">    </span><span class="hl-7">// ... </span><br/><span class="hl-1">}</span><br/><br/><span class="hl-5">private</span><span class="hl-1"> </span><span class="hl-5">void</span><span class="hl-1"> </span><span class="hl-6">_OnSign</span><span class="hl-1">(</span><span class="hl-5">object</span><span class="hl-1"> </span><span class="hl-0">sender</span><span class="hl-1">, </span><span class="hl-11">SignEventArgs</span><span class="hl-1"> </span><span class="hl-0">e</span><span class="hl-1">)</span><br/><span class="hl-1">{</span><br/><span class="hl-1">    </span><span class="hl-5">var</span><span class="hl-1"> </span><span class="hl-0">signatureProperties</span><span class="hl-1"> = </span><span class="hl-0">e</span><span class="hl-1">.</span><span class="hl-0">SignatureProperties</span><span class="hl-1">;</span><br/><span class="hl-1">    </span><span class="hl-11">X509Certificate2</span><span class="hl-1"> </span><span class="hl-0">certificate</span><span class="hl-1"> = </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-11">X509Certificate2</span><span class="hl-1">(</span><span class="hl-0">System</span><span class="hl-1">.</span><span class="hl-0">IO</span><span class="hl-1">.</span><span class="hl-0">File</span><span class="hl-1">.</span><span class="hl-6">ReadAllBytes</span><span class="hl-1">(</span><span class="hl-3">&quot;certificate.pfx&quot;</span><span class="hl-1">), </span><span class="hl-3">&quot;password&quot;</span><span class="hl-1">, </span><br/><span class="hl-1">      </span><span class="hl-0">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-0">MachineKeySet</span><span class="hl-1"> | </span><span class="hl-0">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-0">PersistKeySet</span><span class="hl-1"> | </span><span class="hl-0">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-0">Exportable</span><span class="hl-1">);</span><br/><span class="hl-1">    </span><span class="hl-0">signatureProperties</span><span class="hl-1">.</span><span class="hl-0">SignatureBuilder</span><span class="hl-1"> = </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-11">Pkcs7SignatureBuilder</span><span class="hl-1">()</span><br/><span class="hl-1">    {</span><br/><span class="hl-1">       </span><span class="hl-0">CertificateChain</span><span class="hl-1"> = </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-11">X509Certificate2</span><span class="hl-1">[] { </span><span class="hl-0">certificate</span><span class="hl-1"> },</span><br/><span class="hl-1">       </span><span class="hl-0">HashAlgorithm</span><span class="hl-1"> = </span><span class="hl-0">Security</span><span class="hl-1">.</span><span class="hl-0">OID</span><span class="hl-1">.</span><span class="hl-0">HashAlgorithms</span><span class="hl-1">.</span><span class="hl-0">SHA512</span><span class="hl-1">,</span><br/><span class="hl-1">       </span><span class="hl-0">Format</span><span class="hl-1"> = </span><span class="hl-0">Pkcs7SignatureBuilder</span><span class="hl-1">.</span><span class="hl-0">SignatureFormat</span><span class="hl-1">.</span><span class="hl-0">adbe_pkcs7_detached</span><br/><span class="hl-1">    };</span><br/><span class="hl-1">}</span>
</code></pre>
</div>
