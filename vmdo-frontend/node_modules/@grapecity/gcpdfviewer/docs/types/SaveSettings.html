<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>SaveSettings | GcDocs PDF Viewer - v4.2.3</title><meta name="description" content="Documentation for GcDocs PDF Viewer - v4.2.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<div class="tsd-signature">Save<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;PDF&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;PNG&quot;</span><span class="tsd-signature-symbol">; </span>pages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>reload<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>saveMode<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Default&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Linearized&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;IncrementalUpdate&quot;</span><span class="tsd-signature-symbol">; </span>sign<span class="tsd-signature-symbol">?: </span><a href="SignatureInfo.html" class="tsd-signature-type" data-tsd-kind="Type alias">SignatureInfo</a><span class="tsd-signature-symbol">; </span>progressTitle<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>progressMessage<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>zoomFactor<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
...
<h3>Example</h3><pre><code class="language-javascript"><span class="hl-7">// Save six pages with indices: 0, 1, 2, 3, 7, 9:</span><br/><span class="hl-9">await</span><span class="hl-1"> </span><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">reload:</span><span class="hl-1"> </span><span class="hl-5">true</span><span class="hl-1">, </span><span class="hl-0">pages:</span><span class="hl-1"> </span><span class="hl-3">&quot;0-3, 7, 9&quot;</span><span class="hl-1"> });</span>
</code></pre>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-7">// Rotate 90 degrees and save 2 pages with indices 2 and 3:</span><br/><span class="hl-9">await</span><span class="hl-1"> </span><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">reload:</span><span class="hl-1"> </span><span class="hl-5">true</span><span class="hl-1">, </span><span class="hl-0">pages:</span><span class="hl-1"> </span><span class="hl-3">&quot;[angle:90]2-3&quot;</span><span class="hl-1"> });</span>
</code></pre>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-7">// Invoke the system file picker dialog </span><br/><span class="hl-7">// to select an external PDF file to merge.</span><br/><span class="hl-7">// Then, merge first page from selected PDF document and</span><br/><span class="hl-7">// download result PDF file to local system.</span><br/><span class="hl-5">var</span><span class="hl-1"> </span><span class="hl-0">fileInput</span><span class="hl-1"> = </span><span class="hl-0">document</span><span class="hl-1">.</span><span class="hl-6">createElement</span><span class="hl-1">(</span><span class="hl-3">&#39;input&#39;</span><span class="hl-1">);</span><br/><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">type</span><span class="hl-1"> = </span><span class="hl-3">&#39;file&#39;</span><span class="hl-1">;</span><br/><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">accept</span><span class="hl-1"> = </span><span class="hl-3">&quot;.pdf&quot;</span><span class="hl-1">;</span><br/><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">style</span><span class="hl-1">.</span><span class="hl-0">display</span><span class="hl-1"> = </span><span class="hl-3">&#39;none&#39;</span><span class="hl-1">;</span><br/><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-6">onchange</span><span class="hl-1"> = </span><span class="hl-5">function</span><span class="hl-1"> () { </span><br/><span class="hl-1">    </span><span class="hl-9">if</span><span class="hl-1"> (</span><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">files</span><span class="hl-1"> &amp;&amp; </span><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">files</span><span class="hl-1">[</span><span class="hl-10">0</span><span class="hl-1">]) {</span><br/><span class="hl-1">        </span><span class="hl-5">var</span><span class="hl-1"> </span><span class="hl-0">fileReader</span><span class="hl-1"> = </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-6">FileReader</span><span class="hl-1">();</span><br/><span class="hl-1">        </span><span class="hl-0">fileReader</span><span class="hl-1">.</span><span class="hl-6">onload</span><span class="hl-1"> = </span><span class="hl-5">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">            </span><span class="hl-5">const</span><span class="hl-1"> </span><span class="hl-8">fileId</span><span class="hl-1"> = </span><span class="hl-3">&quot;uniquefileid_&quot;</span><span class="hl-1"> + </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-11">Date</span><span class="hl-1">().</span><span class="hl-6">getTime</span><span class="hl-1">();</span><br/><span class="hl-1">            </span><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-0">storage</span><span class="hl-1">.</span><span class="hl-6">setItem</span><span class="hl-1">(</span><span class="hl-0">fileId</span><span class="hl-1">, </span><span class="hl-5">new</span><span class="hl-1"> </span><span class="hl-11">Uint8Array</span><span class="hl-1">(</span><span class="hl-0">fileReader</span><span class="hl-1">.</span><span class="hl-0">result</span><span class="hl-1">));</span><br/><span class="hl-1">            </span><span class="hl-7">// Merge first page from external PDF document </span><br/><span class="hl-1">            </span><span class="hl-7">// to the end of the active PDF document</span><br/><span class="hl-1">            </span><span class="hl-7">// and download result PDF file:</span><br/><span class="hl-1">            </span><span class="hl-9">await</span><span class="hl-1"> </span><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;sample.pdf&quot;</span><span class="hl-1">, </span><br/><span class="hl-1">                { </span><span class="hl-0">pages:</span><span class="hl-1"> </span><span class="hl-3">`0-</span><span class="hl-5">${</span><span class="hl-0">viewer</span><span class="hl-12">.</span><span class="hl-0">pageCount</span><span class="hl-12"> </span><span class="hl-1">-</span><span class="hl-12"> </span><span class="hl-10">1</span><span class="hl-5">}</span><span class="hl-3">, [file:</span><span class="hl-5">${</span><span class="hl-0">fileId</span><span class="hl-5">}</span><span class="hl-3">]0`</span><span class="hl-1">  });</span><br/><span class="hl-1">        };</span><br/><span class="hl-1">        </span><span class="hl-0">fileReader</span><span class="hl-1">.</span><span class="hl-6">readAsArrayBuffer</span><span class="hl-1">(</span><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-0">files</span><span class="hl-1">[</span><span class="hl-10">0</span><span class="hl-1">]);</span><br/><span class="hl-1">    }</span><br/><span class="hl-1">};</span><br/><span class="hl-0">document</span><span class="hl-1">.</span><span class="hl-0">body</span><span class="hl-1">.</span><span class="hl-6">appendChild</span><span class="hl-1">(</span><span class="hl-0">fileInput</span><span class="hl-1">);</span><br/><span class="hl-0">fileInput</span><span class="hl-1">.</span><span class="hl-6">click</span><span class="hl-1">();</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<h3>Example0</h3><pre><code class="language-javascript"><span class="hl-7">// Save dodument and load saved document into the viewer:</span><br/><span class="hl-9">await</span><span class="hl-1"> </span><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">reload:</span><span class="hl-1"> </span><span class="hl-5">true</span><span class="hl-1"> });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<pre><code class="language-javascript"><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">pages:</span><span class="hl-1"> </span><span class="hl-3">&quot;[angle:90]0,1-5&quot;</span><span class="hl-1">, </span><span class="hl-0">progressTitle:</span><span class="hl-1"> </span><span class="hl-3">&quot;Rotating&quot;</span><span class="hl-1"> }, </span><span class="hl-0">reload</span><span class="hl-1">: </span><span class="hl-5">true</span><span class="hl-1">);</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<pre><code class="language-javascript"><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">pages:</span><span class="hl-1"> </span><span class="hl-3">&quot;[angle:90]0,1-5&quot;</span><span class="hl-1">, </span><span class="hl-0">progressMessage:</span><span class="hl-1"> </span><span class="hl-3">&quot;Rotating first page...&quot;</span><span class="hl-1"> }, </span><span class="hl-0">reload</span><span class="hl-1">: </span><span class="hl-5">true</span><span class="hl-1">);</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
...
<pre><code class="language-javascript"><span class="hl-0">viewer</span><span class="hl-1">.</span><span class="hl-6">save</span><span class="hl-1">(</span><span class="hl-3">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-0">format:</span><span class="hl-1"> </span><span class="hl-3">&quot;PNG&quot;</span><span class="hl-1">, </span><span class="hl-0">zoomFactor:</span><span class="hl-1"> </span><span class="hl-10">1.5</span><span class="hl-1"> });</span>
</code></pre>
</div></li></ul></div></div>
...
<ul>
<li class="tsd-kind-type-alias"><a href="SignatureInformation.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="var(--color-ts)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6" id="icon-4194304-path"></rect><path d="M11.31 16V8.224H8.91V7.24H14.79V8.224H12.39V16H11.31Z" fill="var(--color-text)" id="icon-4194304-text"></path></svg>Signature<wbr/>Information</a></li>
...
<li class="tsd-kind-type-alias"><a href="AnnotationMarkedStateType.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Annotation<wbr/>Marked<wbr/>State<wbr/>Type</a></li>
...
<li class="tsd-kind-type-alias"><a href="WidgetFieldTypeName.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Widget<wbr/>Field<wbr/>Type<wbr/>Name</a></li>
...
<li class="tsd-kind-class"><a href="../classes/ViewerOptions.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-128-path"></use><use href="#icon-128-text"></use></svg>Viewer<wbr/>Options</a></li></ul></nav></div></div>
